...
public class ItemListFragment extends ListFragment {
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        switch (position){
            ...
            case 1:
                TelemetryManager.trackEvent("My side by side event");
                break;
            case 2:
                TelemetryManager.trackTrace("My side by side message");
                break;
            case 3:
                TelemetryManager.trackMetric("My side by side metric", 2.3);
                break;
            case 4:
